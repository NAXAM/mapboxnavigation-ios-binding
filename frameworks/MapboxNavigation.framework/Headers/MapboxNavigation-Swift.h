...
///
/// \endcode
@property (nonatomic, strong) id <MGLAnnotation> _Null_unspecified destination SWIFT_DEPRECATED_MSG("Destination is no longer supported. A destination annotation will automatically be added to map given the route.");
